...
add     r4,#Proc_InitialOffset
	@ start proc to display sprites
mov		r1,r7
ldr		r0,=Augury_DisplaySpritesProc
_blh	StartProc
mov		r1,#0
add		r0,#Proc_InitialOffset
strh	r1,[r0,#Proc_SpriteTimer]
strh	r1,[r0,#Proc_ArrowOffset]	@ updated in Augury_ChapterText
	@ clear all 
mov     r0,#0
_blh    #0x80026BC
...
@;ldr		r0,=#(Augury_Graphics_Tile_Number+0x40)			@tile id
@;mov		r1,#(Augury_Graphics_Palette_Bank+1)			@palette id
...
strh	r2,[r0,r1]
mov		r1,#BLDALPHA
ldr		r2,=#0x070E	@coefficients; 7 is for sprite, E for layer 3
strh	r2,[r0,r1]
b		SkipLiteralPool1
.ltorg
SkipLiteralPool1:
...
ldr		r0,[r1,#0x14]
cmp		r0,#0
bne		Aug_CheckRPress_Label1
ldr		r0,=Aug_RBubble1
str		r0,[r1,#0x14]
Aug_CheckRPress_Label1:
mov		r1,r6
_blh	StartStatScreenHelpTextBubble		@ used for stat screen, but I think it can be used in this instance
mov		r0,r6
_blh	BreakProcLoop
...
Rank_BG_OAM_Base:
.short 4
.short 0x4400, 0xC000, 0x0C15
.short 0x4400, 0xC040, 0x0C15
.short 0x4400, 0xC080, 0x0C15
.short 0x4400, 0xC0C0, 0x0C15
.align
Rank_OAM_Base:
.short 2
.short 0x4400, 0x8000, 76
.short 0x4400, 0x8020, 80
.align
BBack_OAM_Base:
.short 2
...
RHelp_OAM_Base:
.short 1
.short 0x4000, 0x8000, 5
.align
LeftArrow_OAM_Base:
.short 1
.short 0x8000, 0x0000, 10
.align
RightArrow_OAM_Base:
.short 1
.short 0x8000, 0x1000, 10		@ flip
.align
AOnly_OAM_Base:
.short 1
.short 0x8000, 0x0000, 9
.align
UpArrow_OAM_Base:
.short 1
.short 0x4000, 0x0000, 64
.align
DownArrow_OAM_Base:
.short 1
.short 0x4000, 0x2000, 64
.align
